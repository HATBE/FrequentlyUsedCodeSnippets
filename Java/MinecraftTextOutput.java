...
public class TextOutput {
	...
	public static final String PREFIX = ChatColor.GRAY + "[" + ChatColor.DARK_PURPLE + "PREFIX" + ChatColor.GRAY + "]" + ChatColor.RESET + " ";
	public static final String PLAIN_PREFIX = "[PREFIX] ";
